/* @ts-self-types="./xenor_xenus.d.ts" */
...
export class XenusGame {
    ...
    place_building(x, y, building_type) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.xenusgame_place_building(retptr, this.__wbg_ptr, x, y, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred2_0 = r0;
            deferred2_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('xenor_xenus_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
